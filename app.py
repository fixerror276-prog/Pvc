...
def index():
    return (
        ...
        "<p>Routes:</p>"
        "<ul>"
        "<li><code>/rc?vehicle=HR26EV0001</code> — PDF Download</li>"
        "<li><code>/rcimg?vehicle=HR26EV0001</code> — Image Download</li>"
        "<li><code>/rchtml?vehicle=HR26EV0001</code> — Raw HTML</li>"
        "</ul>"
    )
